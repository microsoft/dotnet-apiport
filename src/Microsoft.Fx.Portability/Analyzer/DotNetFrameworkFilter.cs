...
namespace Microsoft.Fx.Portability.Analyzer
{
    public class DotNetFrameworkFilter : IDependencyFilter
    {
        ...
        /// </summary>
        private static readonly ICollection<string> _microsoftKeys = new HashSet<string>(new[]
        {
        ...
        private static readonly IEnumerable<string> _frameworkAssemblyNamePrefixes = new[]
        {
            "System.",
            "Microsoft.",
            "Mono."
        ...
        public bool IsFrameworkAssembly(AssemblyReferenceInformation assembly)
        {
            ...
            if (_microsoftKeys.Contains(assembly.PublicKeyToken))
            {
                return true;
            }

            if (_frameworkAssemblyNamePrefixes.Any(p => assembly.Name.StartsWith(p, StringComparison.OrdinalIgnoreCase)))
            {
                return true;
            }
