...
namespace Microsoft.Fx.Portability
{
    ...
    /// </summary>
    public class UrlBlobCache<TObject> : UpdatingObjectCache<TObject>
    {
        private readonly string _url;
        private readonly bool _compressed;

        public UrlBlobCache(string url, bool compressed, CancellationToken cancellationToken, TimeSpan cachePollInterval)
            : base(cancellationToken, cachePollInterval, url)
        {
            _url = url;
